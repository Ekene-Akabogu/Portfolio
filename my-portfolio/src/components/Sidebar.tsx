            ...
            <Sheet>
                <SheetTrigger asChild>
                    <Button 
                        ...
                        bg-neutral-800 py-5 px-5 hover:text-primary cursor-pointer'
                    >
                        <MenuIcon size={30}/>
                    </Button>
                </SheetTrigger>
                ...
                <SheetContent
                    side='right'
                    className='w-84 bg-neutral-900 text-neutral-100 py-6 px-10 flex flex-col'
                    >
                        ...
                        {socialLinks.map((social, i) => {
                            ...
                            return (
                                <a 
                                    key={i} 
                                    href={social.link}
                                    className="hover:text-primary border-2 border-neutral-500 p-2 rounded-full
