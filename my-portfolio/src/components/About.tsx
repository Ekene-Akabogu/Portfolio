...
export const About = () => {
    return (
        ...
        >
            ...
            >
                I am a passionate Software Engineer and UI/UX Designer with a strong foundation in building responsive, 
            ...
            <motion.p
                ...
                className="mt-4 text-neutral-300"
            >
                Beyond software development and design, I have a growing interest in cybersecurity and data science, exploring ways to make digital experiences 
